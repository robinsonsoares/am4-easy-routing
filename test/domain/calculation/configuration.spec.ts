...
describe('Configuration Calculation', () => {
    it('should return the demand when total capacity is 0', () => {
        ...
        const configurationCalculation = new ConfigurationCalculation(capacityTotal)
    ...
    it('should return the demand when total capacity is not provided', () => {
        ...
        const configurationCalculation = new ConfigurationCalculation(capacityTotal as any)
        const result = configurationCalculation.calculate(demand)
    ...
    it('should return the corret value when parameters are provided', () => {
        const demand = 10

...
describe('File Airplane Repository', () => {
    ...
    describe('loadByManufacturer', () => {
        it('it shoul throw an error when manufacturer is not providede', () => {
            const repository = new FileAirplaneRepository(mockData)
            const result = repository.loadByManufacturer(null as any)

            expect(result).rejects.toThrow(new Error('Manufacturer is required!'))

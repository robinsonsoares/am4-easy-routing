...
export const create = async (req: Request, res: Response) => {
    ...
    const airlanemanagerAPI = new AirlinemanagerAPI(process.env.AIRLINE_MANAGER_ACCESS_TOKEN as string)

    const result = await airlanemanagerAPI.getRouteDemand(configurationProps.departureICAO, airplane.getRange(), runway)
